...
| [`dont have any permissions` is a missing audit role](graph/audit-query-permission-vs-audit-role.md) | Consent got you to the backend; the *user* still needs Audit Reader/Manager — Global Admin does not count |
