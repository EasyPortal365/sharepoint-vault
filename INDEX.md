...
- 💥 **[gotchas/](gotchas/)** — real-world traps as *symptom → cause → fix*
  ...
  - **spfx/**
    ...
    - [rules-of-hooks false-positive from a JSX `&&` chain](gotchas/spfx/rules-of-hooks-false-positive-from-jsx-chain.md) — a complex conditional in your render blames the *wrong* hook; extract it to a `const`. Second trigger: sheer component *size* — there extracting conditions doesn't help, splitting the component does
