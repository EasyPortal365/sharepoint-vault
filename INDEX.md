...
- 💥 **[gotchas/](gotchas/)** — real-world traps as *symptom → cause → fix*
  ...
  - **spfx/**
    ...
    - [A theme override on your app root can't reach tokens declared on `:root`](gotchas/spfx/theme-override-cant-reach-root-declared-tokens.md) — the accent inherits, everything derived from it doesn't; substitution happens where the token is declared, and portals miss the override entirely
